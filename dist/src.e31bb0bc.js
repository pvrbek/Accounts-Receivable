...
function editData() {
  var edit = document.querySelectorAll('.menu-box .edit');
  var parent;
  var allData;
  var checkOut;
...
function saveData() {
  var allData = document.querySelectorAll('.data p.info');
...
function getStatus() {
  var status = document.querySelectorAll('.list-row .ispaid');
